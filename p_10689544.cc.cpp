...
void deletestudentrecord()
{
    ...
    student stu1;
    fstream intofile ("record.txt");
    fstream intofile1 ("record2.txt");
    fstream temporalfile ("temp9.txt",ios::app);
    fstream temporalfile1 ("temp10.txt",ios::app);
    string line,line1;
    ...
    while(std::getline(intofile, line))
    {
     ...
     while(std::getline(intofile1, line1))
    {
        istringstream ss1(line1);
        std::istream_iterator<std::string> begin(ss1), end;
        //putting all the tokens in the vector
        std::vector<std::string> arrayTokens1(begin, end);

        vector<string>::iterator it1;
        int i1=0,flag1=0;
        for(it1 = arrayTokens1.begin(); it1 != arrayTokens1.end(); it1++)
        {
            if(i1==0 && id1==*it1)
            {
                flag1=1;
...
void studentsrecordlist()
{
    ...
    cout <<setw(15) <<"ID"<<setw(15)<<"FIRST_NAME"<<setw(15)<<"LAST_NAME"<<setw(20)<<"ACADEMIC_WRITING"<<setw(15)<<"MATHEMATICS"<<setw(15)<<"PROGRAMMING"<<setw(15)<<"STATISTICS"<<setw(10)<<"CULTURE"<<endl<<endl;
    string line;
    while(std::getline(outputfile, line))
    {
        istringstream ss(line);
...
void display()
{
    ...
    cout<< "\npress 5 again to confirm add student record: ";cin>>inchoice;
    for (a=0; inchoice!='n'&&inchoice!='N'; a++){
            if((inchoice=='y')||(inchoice=='Y')||(inchoice=='5')){
...
f2.close();
cout<< "\n\n\n\nEnter 'Y' to display another or 'N' to finish and exit to main menu: "; cin>>inchoice;
            }
    }
    system("cls");
    return;
...
int main()
{
    ...
    while(1)
    {
            ...
            cout <<endl<<endl;
            cout << "\t\t\t\t SCHOOL MANAGEMENT SYSTEM\n\t\t\t\t(by: Albert Nartey - 10689544)"<< endl;
            ...
            cout << "\t\t\t4. STUDENT (ADD/EDIT/DELETE/SHOW ALL STUDENTS)"<< endl;
